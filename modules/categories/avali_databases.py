"""
BANCO DE DADOS DA CATEGORIA: Avaliações de bnco de dados
...
def banner_avaliacoes_database():
    banner()
    banner_avaliacoes = open("modules/banners/categ_avaliacoes.txt")
    print(banner_avaliacoes.read())
    backmenu_inicial()
